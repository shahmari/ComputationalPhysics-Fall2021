...
\begin{document}
    ...
    \begin{figure}[!htb]
        \centering
        \includegraphics[scale = 0.4]{/Q2/Graphic}
        \label{fig:2.1}
    ...
    \begin{figure}[!htb]
        \centering
        \includegraphics[scale = 0.27]{/Q2/H-t(L=50)}
        \label{fig:2.2}
        \includegraphics[scale = 0.27]{/Q2/W-t(L=50)}
        \label{fig:2.3}
        \caption{Ballistic Deposition for $L=50$}
    \end{figure}
    \begin{figure}[!htb]
        \centering
        \includegraphics[scale = 0.27]{/Q2/H-t(L=100)}
        \label{fig:2.4}
        \includegraphics[scale = 0.27]{/Q2/W-t(L=100)}
        \label{fig:2.5}
        \caption{Ballistic Deposition for $L=100$}
    \end{figure}
    \begin{figure}[!htb]
        \centering
        \includegraphics[scale = 0.27]{/Q2/H-t(L=200)}
        \label{fig:2.6}
        \includegraphics[scale = 0.27]{/Q2/W-t(L=200)}
        \label{fig:2.7}
        \caption{Ballistic Deposition for $L=200$}
    \end{figure}
    \begin{figure}[!htb]
        \centering
        \includegraphics[scale = 0.27]{/Q2/H-t(L=300)}
        \label{fig:2.8}
        \includegraphics[scale = 0.27]{/Q2/W-t(L=300)}
        \label{fig:2.9}
    ...
    \begin{figure}[!htb]
        \centering
        \includegraphics[scale = 0.5]{/Q3/Q3-L(t)}
        \label{fig:3.2}
